"""
This code was taken from the RL Zoo package:
...
def register_water_envs():
    register(
        id='Net1Discrete-v0',
        entry_point='pump_control_envs:net1_discrete_env'
    )
    register(
        id='Net1Continuous-v0',
        entry_point='pump_control_envs:net1_continuous_env'
    )
    register(
        id='Net1RestrictedContinuous-v0',
        entry_point='pump_control_envs:net1_restricted_continuous_env'
    )
    register(
        id='AnytownDiscrete-v0',
        entry_point='pump_control_envs:anytown_discrete_env'
    )
    register(
        id='AnytownContinuous-v0',
        entry_point='pump_control_envs:anytown_continuous_env'
    )
    register(
        id='AnytownRestrictedContinuous-v0',
        entry_point='pump_control_envs:anytown_restricted_continuous_env'
    )
